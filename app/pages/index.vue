<template>
	<main class="grid 2xl:grid-cols-4 xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 mx-auto">
		<RepoCard v-for="(item, index) in data?.data" v-if="isFilteredRepoExists" :key="index" :data="item" />
